...
**WORK in Progress - The use of polynomial to predicts the SG needs verification in detail.**
...
* Sound detecting is prone to sound, hence, best placed in fridge especially if no interference is seen from your fridge! *Pleast Notice, use in fridge is not fully tested yet (Interference)!
...
2. Install Arduino IDE 
   ...
   - Download "tinyexpr.h" and "ubidotsesp8266.h" (se above folders) and place in libraries folder in it own directory.
